              ...
              <FormField
                  ...
                  render={({ field }) => (
                      <FormItem>
                          ...
                          <FormControl><RichTextEditor placeholder="Describe any missing items..." value={field.value ?? ""} /></FormControl>
                          <FormMessage />
                      </FormItem>
                  )}
              />
              ...
              <FormField
                  ...
                  render={({ field }) => (
                      <FormItem>
                          ...
                          <FormControl><RichTextEditor placeholder="Describe any extra items found..." value={field.value ?? ""} /></FormControl>
                          <FormMessage />
                      </FormItem>
                  )}
              />
