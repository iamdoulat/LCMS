...
export function EditInstallationReportForm({ initialData, reportId }: EditInstallationReportFormProps) {
          ...
          if (initialData.selectedCommercialInvoiceLcId && lcOptionsForCommercialInvoice.length > 0) { 
             ...
             if (selectedLcOption) {
                ...
                setSelectedLcDetails({
                    ...
                    secondPartialQty: lc.secondPartialQty, secondPartialPkgs: lc.secondPartialPkgs, secondPartialNetWeight: lc.secondPartialGrossWeight, secondPartialGrossWeight: lc.secondPartialGrossWeight, secondPartialCbm: lc.secondPartialCbm,
  ...
  async function onSubmit(data: InstallationReportFormValues) {
    ...
    for (const key in dataToUpdate) {
        ...
        if (value !== undefined) { // Allow empty strings, but not undefined
