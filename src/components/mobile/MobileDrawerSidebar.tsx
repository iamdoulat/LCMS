    ...
    return (
        <div className="fixed inset-y-0 left-0 w-[60%] bg-[#4c35de] text-white z-0 flex flex-col pt-12 pb-6 px-6 overflow-y-auto shadow-2xl">
            ...
            <div className="mt-auto">
                ...
                <button
                    onClick={logout}
                    className="w-full bg-white/10 backdrop-blur-xl border border-white/20 rounded-full py-2.5 flex items-center justify-center gap-3 mt-8 transition-all active:scale-95 shadow-xl group hover:bg-white/20"
                >
