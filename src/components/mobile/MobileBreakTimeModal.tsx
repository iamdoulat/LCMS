...
export function MobileBreakTimeModal({ isOpen, onClose, isFrozen = false, externalIsOnBreak, externalBreakRecord }: MobileBreakTimeModalProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-md p-0 overflow-hidden bg-slate-50 border-0 h-auto max-h-[85vh] sm:h-auto flex flex-col relative w-[90%] rounded-2xl top-[200px] translate-y-0">
