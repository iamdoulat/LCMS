...
interface AddCommissionInvoiceFormProps {
    defaultDate?: string;
}

export function AddCommissionInvoiceForm({ defaultDate }: AddCommissionInvoiceFormProps) {
    ...
    const form = useForm<CommissionInvoiceFormValues>({
        ...
        defaultValues: {
            ...
            applicantId: '',
            piNo: '',
            piDate: defaultDate ? new Date(defaultDate) : new Date(),
            salesPersonName: '',
            connectedLcId: '',
            purchaseOrderUrl: '',

            lineItems: [{ slNo: '1', modelNo: '', qty: '', purchasePrice: '', salesPrice: '', oviAmount: '', netCommissionPercentage: '' }],
    ...
    React.useEffect(() => {
        const fetchOptions = async () => {
            ...
            try {
                ...
                console.error("Error fetching dropdown options for CI form: ", error);
    ...
    async function onSubmit(data: CommissionInvoiceFormValues) {
        ...
        try {
            ...
            Swal.fire({
                title: "Success!",
                text: "Commission Invoice has been successfully saved.",
                icon: "success",
                timer: 1000,
            ...
            console.error("Error adding Commission Invoice document: ", error);
            Swal.fire({
                title: "Save Failed",
                text: `Failed to save Commission Invoice: ${error.message}`,
                icon: "error",
            });
        } finally {
