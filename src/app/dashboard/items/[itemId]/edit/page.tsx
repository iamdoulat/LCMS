// This file is obsolete and will be removed. The new page is at /dashboard/inventory/items/[itemId]/edit/page.tsx
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import Link from 'next/link';

export default function DeprecatedEditItemPage() {
  return (
