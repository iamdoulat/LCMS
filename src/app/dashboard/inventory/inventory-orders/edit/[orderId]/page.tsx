...
export default function EditPurchaseOrderPage() {
      ...
      <div className="container mx-auto py-8">
        <Card className="max-w-screen-2xl mx-auto shadow-xl border-destructive">
          ...
          <CardContent><p className="text-destructive-foreground">{error}</p>
            <Button variant="outline" asChild className="mt-4"><Link href="/dashboard/inventory/inventory-orders/list"><ArrowLeft className="mr-2 h-4 w-4" />Back to Purchase Orders List</Link></Button>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6"><Link href="/dashboard/inventory/inventory-orders/list" passHref><Button variant="outline"><ArrowLeft className="mr-2 h-4 w-4" />Back to Purchase Orders List</Button></Link></div>
