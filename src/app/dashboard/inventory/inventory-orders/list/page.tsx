...
import { PlusCircle, FileEdit, Trash2, Loader2, Filter, XCircle, Building, ChevronLeft, ChevronRight, MoreHorizontal, Printer, ShoppingCart, CalendarDays } from 'lucide-react';
...
export default function OrdersListPage() {
  ...
  const handleEditOrder = (orderId: string) => {
    router.push(`/dashboard/inventory/inventory-orders/edit/${orderId}`);
  };
      ...
      <Card className="shadow-xl">
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <Link href="/dashboard/inventory/inventory-orders/create" passHref>
