...
import { AddDepartmentForm } from '@/components/forms/hr';
import { EditDepartmentForm } from '@/components/forms/hr';
import { AddUnitForm } from '@/components/forms/hr';
import { EditUnitForm } from '@/components/forms/hr';
import { AddDivisionForm } from '@/components/forms/hr';
import { EditDivisionForm } from '@/components/forms/hr';
import { AddLeaveTypeForm } from '@/components/forms/hr';
        ...
        <div className="max-w-none mx-[10px] md:mx-[25px] mt-[10px] md:mt-0 mb-[50px] md:mb-0 py-8 px-0">
            <Card className="shadow-xl">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    {/* Salary Calculation Settings Section */}
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium flex items-center gap-2">
                        ...
                        <CardContent>
                            <div className="flex justify-between items-center">
                                ...
                                <Button asChild size="sm" variant="outline">
                                    <Link href="/dashboard/settings/salary-calculation">Open</Link>
                                </Button>
                            </div>
                            <p className="text-xs text-muted-foreground mt-1">Set default allowances for salary breakdown</p>
                        </CardContent>
                    </Card>
