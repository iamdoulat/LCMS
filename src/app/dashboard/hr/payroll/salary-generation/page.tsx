...
export default function SalaryGenerationPage() {
    ...
    const onGenerateSalary = async (data: SalaryGenerationFormValues) => {
        ...
        try {
            ...
            Swal.fire({ title: "Salary Generation Complete!", text: `Successfully generated payroll for ${processedCount} employees for ${payPeriod}.`, icon: "success" });        } catch (error: any) {
