...
import type { EmployeeDocument, AttendanceDocument, HolidayDocument, LeaveApplicationDocument, CompanyProfile } from '@/types';
    ...
    return (
        <div ref={printContainerRef} className="bg-white font-sans text-gray-800 p-8" style={{ width: '210mm', minHeight: '297mm', margin: 'auto' }}>
            <header className="flex justify-between items-center mb-4">
                <div>
                    {companyProfile?.companyLogoUrl && <Image src={companyProfile.companyLogoUrl} alt="Company Logo" width={200} height={50} className="object-contain" data-ai-hint="company logo"/>}
                </div>
            ...
            <Table className="text-xs border">
                <TableHeader><TableRow>
                    <TableHead className="p-1 border">Attendance Date</TableHead><TableHead className="p-1 border">Status</TableHead><TableHead className="p-1 border">Expected Duty (Hour)</TableHead><TableHead className="p-1 border">In Time</TableHead><TableHead className="p-1 border">Out Time</TableHead><TableHead className="p-1 border">Break Time (Hour)</TableHead><TableHead className="p-1 border">Actual Duty (Hour)</TableHead><TableHead className="p-1 border">Extra/Less Duty (Hour)</TableHead><TableHead className="p-1 border">Remarks</TableHead>
