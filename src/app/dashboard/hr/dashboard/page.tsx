...
export default function HrmDashboardPage() {
    ...
    if (isLoading) {
        return (
            <div className="max-w-none mx-[10px] md:mx-[25px] mt-[10px] md:mt-0 mb-[50px] md:mb-0 py-0 md:py-8 px-0">
    ...
    return (
        <div className="max-w-none mx-[10px] md:mx-[25px] mt-[10px] md:mt-0 mb-[50px] md:mb-0 py-0 md:py-8 space-y-8 px-0">
