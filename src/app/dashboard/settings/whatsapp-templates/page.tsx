...
export default function WhatsAppTemplatesPage() {
    ...
    const handleExport = () => {
        try {
            ...
            link.href = url;
            link.download = `whatsapp_templates_export_${new Date().toISOString().split('T')[0]}.json`;
        ...
        try {
            ...
            reader.onload = async (event) => {
                try {
                    ...
                    const templatesRef = collection(firestore, 'whatsapp_templates');
                    ...
                    for (const t of importedTemplates) {
                        ...
                        if (!snapshot.empty) {
                            // Update existing
                            const docRef = doc(firestore, 'whatsapp_templates', snapshot.docs[0].id);
