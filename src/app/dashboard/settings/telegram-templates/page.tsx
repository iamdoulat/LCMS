...
import { Plus, Edit, Trash2, FileText, Send, Loader2 } from 'lucide-react';
...
export default function TelegramTemplatesPage() {
    ...
    const handleDelete = async (id: string, name: string) => {
        try {
            ...
            if (result.isConfirmed) {
                await deleteDoc(doc(firestore, 'telegram_templates', id));
    ...
    const handleToggle = async (id: string, currentStatus: boolean, name: string) => {
        try {
            await updateDoc(doc(firestore, 'telegram_templates', id), {
            ...
            {loading ? (
                ...
                <Card>
                    <CardContent className="flex flex-col items-center justify-center p-12 text-center">
                        ...
                        <p className="text-muted-foreground mb-6">Create your first Telegram template to get started.</p>
                        <Link href="/dashboard/settings/telegram-templates/new">
                            <Button>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between pt-2 border-t">
                                        ...
                                        <div className="flex gap-2">
                                            <Link href={`/dashboard/settings/telegram-templates/${template.id}`}>
