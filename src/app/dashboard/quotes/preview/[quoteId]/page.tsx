...
const DEFAULT_FINANCIAL_COMPANY_NAME = 'SMART SOLUTION PTE LTD.';
const DEFAULT_FINANCIAL_ADDRESS = '236A Serangoon Road, #02-236A, Singapore 218084';
const DEFAULT_FINANCIAL_EMAIL = 'info@smartsolution-bd.com';
const DEFAULT_FINANCIAL_PHONE = '+6593218129';
...
const formatCurrency = (amount?: number, currencySymbol: string = '') => {
    ...
    return currencySymbol ? `${currencySymbol} ${formattedAmount}` : formattedAmount;
};
...
export default function PrintQuotePage() {
    ...
    try {
      ...
      if (settingsDocSnap.exists()) {
        ...
        setFinancialSettings({
          ...
          cellNumber: DEFAULT_FINANCIAL_PHONE,
  ...
  const displayCompanyPhone = financialSettings?.cellNumber || DEFAULT_FINANCIAL_PHONE;
      ...
      <div className="flex-grow p-8 pb-4">
        ...
        {quoteData.subject && (
          <section className="mb-4 p-2 border rounded-md text-center">
            <p className="text-[10px] font-semibold">{quoteData.subject}</p>
          </section>
        )}
        ...
        <section className="flex-grow">
          <table className="w-full text-sm border-collapse table-fixed">
            <thead className="bg-gray-100 text-gray-700">
              <tr>
                <th className="p-2 border border-gray-300 text-center font-semibold w-[5%]">#</th>
                ...
                <th className="p-2 border border-gray-300 text-right font-semibold w-[15%] whitespace-nowrap">Unit Price</th>
        ...
        <div className="flex justify-between items-end">
            ...
            <div className="w-auto text-sm space-y-1 min-w-[250px]">
                ...
                <div className="grid grid-cols-[auto_1fr] gap-x-4 text-base font-bold">
                    ...
                    <span className="text-gray-900 text-right">{formatCurrency(quoteData.totalAmount)}</span>
                </div>
            </div>
        </div>
      </div>
