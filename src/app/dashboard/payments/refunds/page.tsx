...
const ALL_YEARS_VALUE = "__ALL_YEARS_PAY_REFUND__";
const ALL_CUSTOMERS_VALUE = "__ALL_CUSTOMERS_PAY_REFUND__";
const ALL_STATUSES_VALUE = "__ALL_STATUSES_PAY_REFUND__";
const SALE_ITEMS_PER_PAGE = 10;

export default function PaymentsRefundsReturnsPage() {
    ...
    <div className="container mx-auto py-8">
      <Card className="shadow-xl">
        <CardHeader>
          ...
          <CardDescription>
            View sales records and process refunds or returns. This action updates sale status and item stock.
          </CardDescription>
        </CardHeader>
        <CardContent>
           <Card className="mb-6 shadow-md p-4">
            <CardHeader className="p-2 pb-4"><CardTitle className="text-xl flex items-center"><Filter className="mr-2 h-5 w-5 text-primary" /> Filter Sales Records</CardTitle></CardHeader>
            <CardContent className="p-2 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                <div><Label htmlFor="saleIdFilterPayRefund" className="text-sm font-medium">Sale ID</Label><Input id="saleIdFilterPayRefund" placeholder="Search by Sale ID..." value={filterSaleId} onChange={(e) => setFilterSaleId(e.target.value)} /></div>
                <div><Label htmlFor="customerFilterPayRefund" className="text-sm font-medium flex items-center"><Users className="mr-1 h-4 w-4 text-muted-foreground"/>Customer</Label>
                ...
                <div><Label htmlFor="yearFilterPayRefund" className="text-sm font-medium flex items-center"><CalendarDays className="mr-1 h-4 w-4 text-muted-foreground"/>Year</Label>
                ...
                <div><Label htmlFor="statusFilterPayRefund" className="text-sm font-medium">Status</Label>
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center space-x-2 py-4">
              ...
              {getPageNumbers().map((page, index) =>
                ...
                : (<span key={`ellipsis-pay-refund-${index}`} className="px-2 py-1 text-sm">{page}</span>)
              )}
