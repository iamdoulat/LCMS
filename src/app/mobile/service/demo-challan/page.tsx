...
export default function DemoChallanPage() {
        ...
        <div className="flex flex-col h-screen bg-[#0a1e60] overflow-hidden">
            ...
            <div className="sticky top-0 z-50 bg-[#0a1e60]">
                <div className="flex items-center px-4 pt-1 pb-6">
                    ...
                    <h1 className="text-xl font-bold text-white ml-2">Demo Challan</h1>
                </div>
            </div>

            {/* Content Container */}
            <div className="flex-1 bg-slate-50 rounded-t-[2.5rem] flex flex-col items-center justify-center px-8 text-center">
                <div className="p-6 bg-amber-100/50 rounded-[2.5rem] mb-6 relative">
                    <FileSpreadsheet className="h-16 w-16 text-amber-600" />
                ...
                <p className="text-slate-500 font-medium leading-relaxed max-w-[280px]">
                    Manage and track your demo challans here. This feature is on its way!
                </p>

                <div className="mt-12 w-full max-w-[200px] h-1.5 bg-slate-200 rounded-full overflow-hidden">
                    <div className="h-full bg-amber-600 w-1/3 rounded-full animate-[progress_2s_ease-in-out_infinite]" />
                </div>
            </div>
