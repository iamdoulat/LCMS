...
import { ArrowLeft, AppWindow, Loader2 } from 'lucide-react';
import { Card, CardContent } from '@/components/ui/card';

// Import the dashboard form component for now
// This will be replaced with a mobile-optimized version
import dynamic from 'next/dynamic';

const DemoApplicationFormPlaceholder = dynamic(
    () => import('@/app/dashboard/demo/demo-machine-application/page'),
    {
        ssr: false,
        loading: () => (
        ...
        <div className="flex flex-col h-screen bg-[#0a1e60] overflow-hidden">
            ...
            <div className="sticky top-0 z-50 px-4 pt-4 pb-6 bg-[#0a1e60]">
                ...
                <div className="relative flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-black text-white tracking-tight">Add Demo Application</h1>
                        <p className="text-[10px] font-bold text-blue-400/80 uppercase tracking-[0.2em]">New Application</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 bg-white rounded-t-[2.5rem] mt-2 pb-[80px] shadow-inner overflow-y-auto">
                <div className="p-6">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-slate-900 leading-tight">Application Form</h2>
                        ...
                        <CardContent className="pt-6">
                            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
                                <p className="text-sm text-amber-900 font-medium">
                                    ...
                                    You are currently viewing the desktop form. For the best experience, please use a desktop browser to add demo applications.
                                </p>
                            </div>

                            {/* Temporarily show desktop form */}
                            <div className="text-center py-12">
                                <p className="text-slate-600 mb-4">Mobile-optimized form coming soon!</p>
                                <button
                                    onClick={() => {
                                        if (typeof window !== 'undefined') {
                                            window.location.href = '/dashboard/demo/demo-machine-application';
                                        }
                                    }}
